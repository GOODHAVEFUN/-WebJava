...
public class HashMapTask {	
	public static void main(String[] args) {
		...
		menuList.put(1,"아메리카노");
		menuList.put(2,"라떼");
		menuList.put(3,"모카");
		menuList.put(4,"바닐라라떼");
		
		
		System.out.println("입력 >>"+(order = scanner.nextInt()));
		
		System.out.println(menuList.get(order) +"는 "+ menu.get(menuList.get(order))+"원입니다");
